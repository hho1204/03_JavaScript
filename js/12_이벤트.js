/* 인라인 이벤트 모델 + this 확인 */
function check1(btn){
  // 매개 변수 btn : 함수 호출시 ()안에 작성된
  //                   check1(this)의 tihs가 대입됨

  // btn === this === 이벤트가 발생한 요소(div.my-btn1)
  console.log(btn);

  // 클릭된 요소(btn)에 작성된 내용이 숫자면 1 증가
  // 아니면 0을 대입
  // Nan(숫자 아님0)
  // isNan(값) : 숫자 아니면 true 
  // Number(값) : number타입으로 변환
...
test2.addEventListener("click", function(){
  ...
  /* 
    ...
    - JS는 inline style로만 css 코드를 작성 할 수 있다
  */
...
for(let i = 0; i < btns.length ; i++){
  ...
  // #result3의 배경식을 color 변수에 저장된 값으로 변경
