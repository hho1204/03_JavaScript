...
addStudent.addEventListener("click", () => {
  ...
  inputBan.value = ''; // 빈 문자열을 value에 대입해 삭제한 효과
  inputNumber.value = ''; // 빈 문자열을 value에 대입해 삭제한 효과
  inputName.value = ''; // 빈 문자열을 value에 대입해 삭제한 효과
...
checkJSON.addEventListener("click", () => {
  ...
  console.log("json 확인 : ", json, typeof json);
  ...
  // 기상청 서버에 7/12 오후 10 전국 미세먼지 농도를 JSON으로 받아오기
